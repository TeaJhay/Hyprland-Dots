...
<br>
  ...
  <a href="https://github.com/TeaJhay/Hyprland-Dots/discussions"><kbd> <br> Discussions <br> </kbd></a>&ensp;&ensp;
...
![GitHub Repo stars](https://img.shields.io/github/stars/TeaJhay/Hyprland-Dots?style=for-the-badge&color=cba6f7) ![GitHub last commit](https://img.shields.io/github/last-commit/TeaJhay/Hyprland-Dots?style=for-the-badge&color=b4befe) ![GitHub repo size](https://img.shields.io/github/repo-size/TeaJhay/Hyprland-Dots?style=for-the-badge&color=cba6f7) <a href="https://discord.gg/kool-tech-world"> <img src="https://img.shields.io/discord/1151869464405606400?style=for-the-badge&logo=discord&color=cba6f7&link=https%3A%2F%2Fdiscord.gg%kool-tech-world"> </a>
...
```bash
sh <(curl -L https://raw.githubusercontent.com/TeaJhay/Hyprland-Dots/main/Distro-Hyprland.sh)
```
...
- [Arch-Linux](https://github.com/TeaJhay/Arch-Hyprland)

- [OpenSUSE(Tumbleweed)](https://github.com/TeaJhay/OpenSuse-Hyprland)

- [Fedora-Linux](https://github.com/TeaJhay/Fedora-Hyprland)

- [Debian-Linux (Trixie & SID)](https://github.com/TeaJhay/Debian-Hyprland)

- [NixOS](https://github.com/TeaJhay/NixOS-Hyprland)

- [Ubuntu 24.04 LTS](https://github.com/TeaJhay/Ubuntu-Hyprland/tree/24.04)
- [Ubuntu 24.10](https://github.com/TeaJhay/Ubuntu-Hyprland/tree/24.10)
- [Ubuntu 25.04](https://github.com/TeaJhay/Ubuntu-Hyprland/tree/25.04)
- [Ubuntu 25.10](https://github.com/TeaJhay/Ubuntu-Hyprland/tree/25.10)
...
- All screenshots are collected here [Screenshots](https://github.com/TeaJhay/screenshots/tree/main/Hyprland-ScreenShots)

### 📦 Whats new?

- To easily track changes, I will be updating the [CHANGELOGS](https://github.com/TeaJhay/Hyprland-Dots/wiki/Changelogs) Screenshots will be included if worth mentioning the changes!
...
- [`MORE INFO HERE`](https://github.com/TeaJhay/Hyprland-Dots/wiki/Install_&_Update)
  > [!Note]
...
```bash
git clone --depth=1 https://github.com/TeaJhay/Hyprland-Dots.git
cd Hyprland-Dots
```
...
```bash
git clone --depth=1 https://github.com/TeaJhay/Hyprland-Dots.git -b development
cd Hyprland-Dots
```
...
- by default, only few wallpapers will be copied (1 each dark and light plus 3 more). You will be offered to download more wallpapers. You can preview/check the additional wallpapers from [`THIS`](https://github.com/TeaJhay/Wallpaper-Bank/tree/main/wallpapers) Link
...
* NVIDIA users / owners, after installation, check [`THIS`](https://github.com/TeaJhay/Hyprland-Dots/wiki/Notes_to_remember#--for-nvidia-gpu-users)

- If you have already set your own keybinds, monitors, etc.... Just copy over from backup created before log-out or reboot. (recommended)

#### 📖 Known issues and possible solutions

- check out this page [FAQ](https://github.com/TeaJhay/Hyprland-Dots/wiki/FAQ) and [UNSOLVED ISSUES](https://github.com/TeaJhay/Hyprland-Dots/wiki/Known_Issues)
...
- More question? click here browse through this [WIKI](https://github.com/TeaJhay/Hyprland-Dots/wiki/)
- If you want the old configs, it is collected on my "Archive" repo. See [HERE](https://github.com/TeaJhay/Hyprland-Dots-releases-Archive)
...
- Want to contribute? Click [`HERE`](https://github.com/TeaJhay/Hyprland-Dots/blob/main/CONTRIBUTING.md) for a guide how to contribute
...
[![Stargazers over time](https://starchart.cc/TeaJhay/Hyprland-Dots.svg?variant=adaptive)](https://starchart.cc/TeaJhay/Hyprland-Dots)
